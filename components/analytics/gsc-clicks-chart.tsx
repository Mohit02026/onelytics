...
const METRICS = [
  { key: 'clicks', label: 'Clicks', color: '#3b82f6', axis: 'right' as const },
  { key: 'impressions', label: 'Impressions', color: '#a78bfa', axis: 'left' as const },
]

export function GscClicksChart({ data }: Props) {
  const [active, setActive] = useState<Set<string>>(new Set(['clicks', 'impressions']))
